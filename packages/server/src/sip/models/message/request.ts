...
export class Request extends Message {
  ...
  get proxyAuthorization(): Challenge {
    return this.getHeader(Message.HEADERS.PROXY_AUTHORIZATION);
  }

  set proxyAuthorization(value: Challenge) {
    this.setHeader(Message.HEADERS.PROXY_AUTHORIZATION, value);
  }

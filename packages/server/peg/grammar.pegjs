...
/ k:"Route"                 HCOLON v:Routes                 CRLF {return [k,v]}
/// k:"x-inin-crn"          HCOLON v:XIninCrn               CRLF {return [k,v]}
/ k:"Record-Route"          HCOLON v:Routes                 CRLF {return [k,v]}
/ k:"WWW-Authenticate"      HCOLON v:WWW_Authenticate       CRLF {return [k,v]}
/ k:"Proxy-Authenticate"    HCOLON v:Proxy_Authenticate     CRLF {return [k,v]}
...
Routes
= STAR {return []}
/ a:Route r:(COMMA v:Route {return v})*
{ return [a].concat(r) }
...
//Routes = f:Route r:(COMMA v:Route {return v})*
//{ return [f].concat(r)}
//
